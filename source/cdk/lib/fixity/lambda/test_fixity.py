...
class TestFixityLambdaFunction(unittest.TestCase):
    ...
    def test_s3_batch_handler_success(self):
        with mock.patch.dict(os.environ, {'SendAnonymizedMetric': 'No', "JOB_QUEUE": self.job_q_arn, "JOB_SIZE_SMALL": self.job_definition_arn, "JOB_SIZE_LARGE": self.job_definition_arn, 'JOB_SIZE_THRESHOLD': '10737418240', 'LogLevel': 'INFO', 'SOLUTION_IDENTIFIER': 'AwsSolution/SO0133/1.1.0', 'AWS_REGION': 'us-east-1'}):
