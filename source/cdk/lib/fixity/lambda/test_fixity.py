...
class TestFixityLambdaFunction(unittest.TestCase):
    def setUp(self):
        ...
        subnet = ec2.create_subnet(CidrBlock="172.16.0.1/24", VpcId=vpc.id)
    ...
    def test_submit_job_success(self):
        with mock.patch.dict(os.environ, {"JOB_QUEUE": self.job_q_arn, "JOB_SIZE_SMALL": self.job_definition_arn, "JOB_SIZE_LARGE": self.job_definition_arn, 'JOB_SIZE_THRESHOLD': '10737418240', 'LogLevel': 'INFO', 'SOLUTION_IDENTIFIER': 'AwsSolution/SO0133/1.1.0'}):
    ...
    def test_s3_batch_handler_success(self):
        with mock.patch.dict(os.environ, {"JOB_QUEUE": self.job_q_arn, "JOB_SIZE_SMALL": self.job_definition_arn, "JOB_SIZE_LARGE": self.job_definition_arn, 'JOB_SIZE_THRESHOLD': '10737418240', 'LogLevel': 'INFO', 'SOLUTION_IDENTIFIER': 'AwsSolution/SO0133/1.1.0', 'AWS_REGION': 'us-east-1'}):
    ...
    def test_s3_api_handler_success(self):
        with mock.patch.dict(os.environ, {"JOB_QUEUE": self.job_q_arn, "JOB_SIZE_SMALL": self.job_definition_arn, "JOB_SIZE_LARGE": self.job_definition_arn, 'JOB_SIZE_THRESHOLD': '10737418240', 'LogLevel': 'INFO', 'SOLUTION_IDENTIFIER': 'AwsSolution/SO0133/1.1.0', 'AWS_REGION': 'us-east-1'}):
            ...
            event = {'queryStringParameters': {'bucket': 'buckettestname', 'key': 'BigBunnySample.mp4'}, 'invocationId': '','invocationSchemaVersion': '1.0'}
    ...
    def test_s3_api_handler_error(self):
        with mock.patch.dict(os.environ, {"JOB_QUEUE": self.job_q_arn, "JOB_SIZE_SMALL": self.job_definition_arn, "JOB_SIZE_LARGE": self.job_definition_arn, 'JOB_SIZE_THRESHOLD': '10737418240', 'LogLevel': 'INFO', 'SOLUTION_IDENTIFIER': 'AwsSolution/SO0133/1.1.0', 'AWS_REGION': 'us-east-1'}):
            from fixity_driver.app import api_handler
            event = {'queryStringParameters': {'bucket': 'buckettestname', 'key': 'BigBunnySamp.mp4'}, 'invocationId': '','invocationSchemaVersion': '1.0'}
            file_content = api_handler(event, '_')
